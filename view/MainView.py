...
from view.EvaluacionActaPartial import ver_historico_acta, agregar_acta, evaluar_criterios, exportar_acta, show_stadistics
...
class MainView:
    ...
    def _dibujar_layout(self):
        ...
        with st.sidebar:
            ...
            self.menu_actual = option_menu("Menu", ["Inicio", 'Crear acta', 'Evaluar acta', 'Exportar acta', 'Ver históricos', 'Estadisticas'],
    ...
    def controlar_menu(self):
        if self.menu_actual == "Inicio":
            ...
            exportar_acta(st, self.controller)
             ...
             show_stadistics(st, self.controller)
